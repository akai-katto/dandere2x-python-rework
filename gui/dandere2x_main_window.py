...
class Ui_Dandere2xMainWindow(object):
    def setupUi(self, Dandere2xMainWindow):
        ...
        self.label_output_resolution.setGeometry(QtCore.QRect(240, 260, 261, 20))
        font = QtGui.QFont()
        ...
        self.label_output_name.setGeometry(QtCore.QRect(240, 240, 261, 20))
        font = QtGui.QFont()
        ...
        self.button_statistics.setGeometry(QtCore.QRect(630, 50, 91, 24))
        self.button_statistics.setObjectName("button_statistics")
        self.progresssBar_upscale_progress_bar = QtWidgets.QProgressBar(self.centralwidget)
        self.progresssBar_upscale_progress_bar.setGeometry(QtCore.QRect(530, 210, 126, 23))
        self.progresssBar_upscale_progress_bar.setProperty("value", 24)
        self.progresssBar_upscale_progress_bar.setTextVisible(False)
        self.progresssBar_upscale_progress_bar.setObjectName("progresssBar_upscale_progress_bar")
        self.label_upscale_frame_of = QtWidgets.QLabel(self.centralwidget)
        self.label_upscale_frame_of.setGeometry(QtCore.QRect(520, 235, 151, 31))
        font = QtGui.QFont()
        ...
        self.progresssBar_upscale_progress_bar.raise_()
